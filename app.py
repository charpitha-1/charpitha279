...
def recommendation():
    global smd, cosine_sim, indices, titles
    if request.method == "POST":
        ...
        smd = pre_df.drop_duplicates(subset="product_name", keep="first")
        ...
        return render_template('recommendation.html', msg=rec_df, columns=rec_df.columns.values, rows=rec_df.values.tolist())
